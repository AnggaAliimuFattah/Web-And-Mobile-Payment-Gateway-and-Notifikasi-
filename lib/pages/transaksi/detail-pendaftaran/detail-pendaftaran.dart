...
class DetailPendaftaran extends StatefulWidget {
  ...
  const DetailPendaftaran({super.key, required this.url, required this.uuid});

  @override
  State<DetailPendaftaran> createState() => _DetailPendaftaranState();
}

class _DetailPendaftaranState extends State<DetailPendaftaran> {
  ...
  Future<void> fetchDataSiswa() async {
    ...
    final url = Uri.parse('${widget.url}/detail-tagihan-pendaftaran');
