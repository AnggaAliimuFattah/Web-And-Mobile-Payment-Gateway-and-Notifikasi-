...
class DetailUas extends StatefulWidget {
  ...
  const DetailUas({super.key, required this.url, required this.uuid});

  @override
  State<DetailUas> createState() => _DetailUasState();
}
...
class _DetailUasState extends State<DetailUas> {
  ...
  Future<void> fetchDataSiswa() async {
    ...
    final url = Uri.parse('${widget.url}/detail-tagihan-uas');
