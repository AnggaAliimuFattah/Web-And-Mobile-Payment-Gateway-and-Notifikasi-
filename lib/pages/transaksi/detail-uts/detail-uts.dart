...
class DetailUts extends StatefulWidget {
  final String uuid;
  final String url;

  const DetailUts({super.key, required this.url, required this.uuid});

  @override
  State<DetailUts> createState() => _DetailUtsState();
}

class _DetailUtsState extends State<DetailUts> {
  ...
  Future<void> fetchDataSiswa() async {
    ...
    final url = Uri.parse('${widget.url}/detail-tagihan-uts');
