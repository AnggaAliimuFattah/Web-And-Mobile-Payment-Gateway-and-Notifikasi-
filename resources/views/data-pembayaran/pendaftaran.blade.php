    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header d-flex">
          <h4 class="card-title">Data Siswa Bayar Pendaftaran</h4>
...
function save()
  ...
  function notif(uuid) {
    ...
    Notiflix.Confirm.show(
      ...
      zIndex: 9999 // Gerakkan elemen 20px ke atas
            ...
            $.ajax({
                url: "/notifikasi-tunggakan-pendaftaran/" + uuid,  // ID diteruskan sebagai bagian dari URL
  ...
  function sender() {
    ...
    Notiflix.Confirm.show(
      ...
      var formData = new FormData($('#bulk_send')[0]);
            $.ajax({
                url: "/notifikasi-tunggakan-pendaftaran-all",  // ID diteruskan sebagai bagian dari URL
