    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header d-flex">
          <h4 class="card-title">Data Siswa Bayar SPP</h4>
                      ...
                      <div class="col-12">
                        <div class="row g-3">
                          ...
                          <div class="col-6 col-sm-6 col-lg-4">
                            ...
                            <select name="bulan" class="form-control dt-input" id="bulan">
                                @foreach ($bulanList as $bulan)
                                  <option value="{{ $bulan }}" {{ $bulan == $bulanSekarang ? 'selected' : '' }}>
                                     {{ $bulan }}
                                  </option>
                                @endforeach                         
                            </select>
...
data: function (d) {
                ...
                d.bulan = $('#bulan').val(); // Ambil nilai dari input tanggal awal
...
function save()
  ...
  function notif(uuid,bulan,tahun) {
    ...
    Notiflix.Confirm.show(
      ...
      zIndex: 9999 // Gerakkan elemen 20px ke atas
            ...
            $.ajax({
                url: "/notifikasi-tunggakan-spp/" + uuid + '/' + tahun +'/' + bulan,
  ...
  function sender() {
    ...
    Notiflix.Confirm.show(
      ...
      var formData = new FormData($('#bulk_send')[0]);
            $.ajax({
                url: "/notifikasi-tunggakan-spp-all",  // ID diteruskan sebagai bagian dari URL
