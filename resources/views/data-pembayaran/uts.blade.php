...
<link rel="stylesheet" href="{{asset('assets/select2-4.1.0/dist/css/select2.min.css')}}" rel="stylesheet" />

<div class="row blocking mt-5">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header d-flex">
          <h4 class="card-title">Data Siswa Bayar UTS</h4>
  ...
  function notif(uuid,kelas) {
    ...
    Notiflix.Confirm.show(
      ...
      zIndex: 9999 // Gerakkan elemen 20px ke atas
            ...
            $.ajax({
                url: "/notifikasi-tunggakan-uts/" + uuid  + '/' + kelas,  // ID diteruskan sebagai bagian dari URL
  ...
  function sender() {
    ...
    Notiflix.Confirm.show(
      ...
      var formData = new FormData($('#bulk_send')[0]);
            $.ajax({
                url: "/notifikasi-tunggakan-uts-all",  // ID diteruskan sebagai bagian dari URL
